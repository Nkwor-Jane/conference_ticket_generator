...
const TicketList = ({errors, formData, handleChange, nextStep}) => {
  ...
  return (
    <div>        
        <div className=" rounded-lg p-4 flex flex-col items-start justify-start ">
            <div className="text-center p-2 rounded-2xl border border-stroke p-3 mb-4 md:w-md w-sm bg-highlight ">
            ...
            <div>
                <div className="md:w-full w-sm ">
                    ...
                    <div className="grid md:grid-cols-3 sm:grid-cols-1 gap-2 md:w-full w-sm border border-stroke bg-regal-blue p-2 rounded-2xl">
                    {ticketTypes.map(({type, access, seats}) =>(
                            <button
                                key={type}
                                name="ticketType"
                                onClick={(e) => handleChange({target:{name: "ticketType", value: type}})}
                                className={`p-2 text-center md:text-left rounded-2xl hover:bg-fade-blue cursor-pointer w-full md:w-auto ${formData.ticketType === type ?  "bg-stroke border-2 border-btn-blue" : 
                ...
                <div className="py-3 md:w-full w-sm">
                    <label className="text-white py-2">Number of Tickets</label><br></br>
                        ...
                        className="py-2 px-2 md:w-110 w-95 rounded-lg text-fade-white border 
                        border-stroke mt-2" >
